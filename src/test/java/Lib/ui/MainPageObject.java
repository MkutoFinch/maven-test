...
public class MainPageObject {
    ...
    private By getLocatorByString(String locatot_with_type) {
        String[] exploded_locator = locatot_with_type.split(Pattern.quote(":"), 2);
        ...
        if (by_type.equals("xpath")) {
            ...
            throw new IllegalArgumentException("Cannot get type of locator. Locator: " + locatot_with_type);
        }
    }
